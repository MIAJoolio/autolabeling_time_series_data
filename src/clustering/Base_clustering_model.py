...
class Base_clustering_model(ABC):
    ...
    def evaluate_results(self, X, y_true=None, config_path=None, search_method="grid_search", n_iter=20):
        """
        ...
        Parameters:
            ...
            config_path (str): Путь к YAML-файлу с сеткой параметров.
        ...
        if search_method == "grid_search":
            ...
            df = Clustering_scorer.bayesian_search(model=self, X=X, y_true=y_true, config_path=config_path, n_iter=n_iter)
        else:
